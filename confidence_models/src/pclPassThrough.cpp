...
void pclPassThrough::setInputCloud(pcl::PointCloud<pcl::PointXYZRGB>& cloudIn) {
  cloud = cloudIn;
}
void pclPassThrough::getInputCloud(pcl::PointCloud<pcl::PointXYZRGB>& cloudOut) {
  cloudOut = cloud;
}
...
void pclPassThrough::filterProcess(pcl::PointCloud<pcl::PointXYZRGB>& cloudOut) {
